                ...
                <form action="/visiteurs/{{ $visiteur->id }}/update" method="post" enctype="multipart/form-data">
                    ...
                    <div class="d-flex align-items-center justify-content-between gap-4">
                        <div class="form-group mb-3 w-50">
                            ...
                            <input class=" rounded-0 " type="text" name="nom" id="nom" required value="{{ $visiteur->nom }}">
                        </div>
                        <div class="form-group mb-3 w-50">
                            <label class="mb-1" for="prenom">Prénom</label>
                            <input class=" rounded-0 " type="text" name="prenom" id="email" required value="{{ $visiteur->prenom }}">
                        </div>
                    </div>
                    <div class="form-group mb-3 ">
                        <label class="mb-1" for="email">Email</label>
                        <input class=" rounded-0 " type="email" name="email" id="email" required value="{{ $visiteur->email }}">
                    </div>

                    <div class="d-flex align-items-center justify-content-between gap-4">
                        <div class="form-group mb-3 w-50">
                            <label class="mb-1" for="contact">Contact</label>
                            <input class=" rounded-0 " type="text" name="contact" id="contact" required value="{{ $visiteur->contact }}">
                        </div>
                        <div class="form-group mb-3 w-50">
                            <label class="mb-1" for="adresse">Adresse</label>
                            <input class=" rounded-0 " type="text" name="adresse" id="adresse" required value="{{ $visiteur->adresse }}">
                        </div>
                    </div>
