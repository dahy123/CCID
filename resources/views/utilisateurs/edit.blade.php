            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 mb-4 h-100 overflow-auto" style="margin-left: 16.6667%;">
                ...
                <form action="/utilisateurs/{{ $utilisateur->id }}/update" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3 ">
                        ...
                        <input class="form-control rounded-0 " type="text" name="pseudo" id="nom" required value="{{ $utilisateur->pseudo }}">
                    </div>
                    <div class="mb-3 ">
                        <label class="mb-1" for="email">Email</label>
                        <input class="form-control rounded-0 " type="email" name="email" id="" required value="{{ $utilisateur->email }}">
                    </div>
                    <div class="mb-3 ">
                        <label class="mb-1" for="email">Mot de passe</label>
                        <input class="form-control rounded-0 " type="password" name="mdp" id="" required value="{{ $utilisateur->mdp }}">
                    </div>
